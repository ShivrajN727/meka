...
| # | User Story | Function| Points Assigned |
| - | ---------- | --------| --------------- |
| E | As a user, I want to ask questions to the LLM, so that I can receive answers                       | Chat with LLM               | 5 |
...
| H | As a logged-in user, I want to reopen my previous conversation, so that I can continue chatting in same thread | Continue Conversation | 2 |

Total effort: 5 + 3 + 4 + 2 = 14 points.   
